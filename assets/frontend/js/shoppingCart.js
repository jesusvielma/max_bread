...
var shoppingCart = (function () {
    ...
    function Item(name, itemId, price, image, oferta, count) {
        this.name = name
        this.price = price
        this.count = count
        this.image = image
    ...
    obj.addItemToCart = function (name, itemId, price, image, oferta, count) {
        for (var i in cart) {
        ...
        var item = new Item(name, itemId, price, image, oferta, count);
        cart.push(item);
        saveCart();
    };
