                    ...
                    <div class="product-list-slider">
                        <ul class="swiper-wrapper product-list product-list-vertical">
                            <li class="swiper-slide wow fadeInUp text-center" data-wow-delay=".2s">
                                <span class="product-list-left pull-left">
                                    <a href="#" data-target="#product-01" data-toggle="modal">
                                        <img alt="product image" class="product-list-primary-img" src="assets/frontend/img/product.png">
                                        <img alt="product image" class="product-list-secondary-img" src="assets/frontend/img/product2.png">
                                    </a>
                                </span>
                                ...
                                <button class="btn btn-default add-item" type="button" data-image="assets/frontend/img/product.png" data-name="Textile classic grey chair" data-cost="400.00" data-id="1" >
                            ...
                            <li class="swiper-slide wow fadeInUp text-center" data-wow-delay=".4s">
                                ...
                                <button class="btn btn-default add-item" type="button" data-image="assets/frontend/img/product3.png" data-name="Textile classic yellow chair" data-cost="300.00" data-id="2" >
                                    <span class="ti-shopping-cart"></span>add to cart
                                </button>
                            </li>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="carousel slide product-slide" id="product-carousel">
                            <div class="carousel-inner cont-slider">
                                <div class="item active"> <img alt="" src="assets/frontend/img/product.png" title=""> </div>
                            ...
                            <ol class="carousel-indicators">
                                <li class="active" data-slide-to="0" data-target="#product-carousel"> <img alt="" src="assets/frontend/img/product.png"> </li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <span class="product-right-section">
                                                <span>$299.00</span>
                                                <button class="btn btn-default add-item" type="button" data-image="assets/frontend/img/product.png" data-name="Textile classic grey chair" data-cost="299.00" data-id="8">
